  ...
  return (
    <section className="py-6 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 bg-card/40 backdrop-blur-sm border border-border/50 rounded-full px-4 py-2 mb-4"
        ...
        >
          {partners.map((partner, index) => (
            <motion.div
              ...
              className="group"
            >
              <Card className="p-2 text-center bg-card/40 backdrop-blur-sm border border-border/50 hover:border-primary/30 hover:bg-card/60 transition-all duration-300 h-full">
                <motion.div
                  className="mb-2"
                  whileHover={{ scale: 1.2, rotate: 5 }}
                  transition={{ duration: 0.3 }}
                >
                  <div className="w-12 h-12 mx-auto bg-gradient-to-br from-primary/20 to-accent/20 rounded-xl flex items-center justify-center group-hover:shadow-glow-sm transition-all duration-300">
